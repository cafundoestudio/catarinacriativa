...
:: Android packaging
set AND_CERT_NAME="bigbang"
set AND_CERT_PASS=caf978
set AND_CERT_FILE=cert\bigbang.p12
...
set IOS_PROVISION=cert\liveaction.mobileprovision
...
set APP_ID=air.liveaction

:: Output packages
set DIST_PATH=dist
set DIST_NAME=liveaction
