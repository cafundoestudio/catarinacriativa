...
:: Android packaging
set AND_CERT_NAME="documentary"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\documentary.p12
...
set IOS_PROVISION=cert\documentary.mobileprovision
...
set APP_ID=air.documentary

:: Output packages
set DIST_PATH=dist
set DIST_NAME=documentary
