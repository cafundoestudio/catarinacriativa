package controller {
	...
	public class Application extends EventDispatcher {
		...
		public function Application(stage:Stage) {
			...
			appView.addEventListener(ApplicationEvent.RECORD_DATA, onHideMenu);
		...
		private function onLoadComplete(event:LoaderEvent):void {
			...
			new ScreenController(appView, "episodes");
			new ActionBarController(appView, "actionbar_episodes");
			new RecordController(appView);
		}
