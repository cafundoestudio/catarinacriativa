...
:: Android packaging
set AND_CERT_NAME="animation"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\animation.p12
...
set IOS_PROVISION=cert\animation.mobileprovision
...
set APP_ID=air.animation

:: Output packages
set DIST_PATH=dist
set DIST_NAME=animation
